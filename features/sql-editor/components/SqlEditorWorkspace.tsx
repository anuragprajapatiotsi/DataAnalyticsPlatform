...
export function SqlEditorWorkspace() {
  return (
    <ResizablePanelGroup orientation="vertical" id="sql-editor-results" className="h-full w-full">
      ...
      <ResizableHandle className="relative h-[2px] bg-slate-200 hover:bg-blue-400 transition-colors cursor-row-resize active:bg-blue-600 after:absolute after:inset-x-0 after:-inset-y-1 after:z-50" />
